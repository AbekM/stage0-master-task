...
public class AnimalOverrideTest {
  ...
  public void classDogExists () {
    Assertions.assertDoesNotThrow(() -> Class.forName("com.epam.OOP.Dog"),
        "Class Dog does not exist");
  }
  ...
  public void classDogHasNoArgsConstructor () {
    try {
      ...
      Assertions.assertNotNull(constructor,
          "There is no constructor with 0 parameters for Dog class");
  ...
  public void getDescriptionReturnCorrectStringForDogClass () {
    try {
      ...
      Assertions.assertEquals("This animal is mostly brown. It has 4 paws and a fur.",
          getDescription.invoke(dog),
          "Method getDescription() does not work correctly for Dog class");
  ...
  public void classBirdExists () {
    Assertions.assertDoesNotThrow(() -> Class.forName("com.epam.OOP.Bird"),
        "Class Bird does not exist");
  }
  ...
  public void classBirdHasNoArgsConstructor () {
    try {
      ...
      Assertions.assertNotNull(constructor,
          "There is no constructor with 0 parameters for Bird class");
    } catch (NoSuchMethodException e) {
  ...
  public void getDescriptionReturnCorrectStringForBirdClass () {
    try {
      ...
      Assertions.assertEquals(
          ...
          getDescription.invoke(bird),
          "Method getDescription() does not work correctly for Bird class");
    } catch (NoSuchMethodException | InstantiationException | IllegalAccessException |
             InvocationTargetException e) {
      Assertions.fail("Some Bird class configuration problems");
    }
